...
class TaskCell: UICollectionViewCell {
    ...
    private func setupLayout() {
        ...
        constraints.append(self.deleteButton.leadingAnchor.constraint(
            greaterThanOrEqualTo: self.label.trailingAnchor, constant: 10))

        constraints.append(self.deleteButton.centerYAnchor.constraint(
            equalTo: self.centerYAnchor))

        constraints.append(self.deleteButton.trailingAnchor.constraint(
            equalTo: self.isDoneSwitch.leadingAnchor, constant: -10))

        constraints.append(self.isDoneSwitch.trailingAnchor.constraint(
            equalTo: self.contentView.trailingAnchor, constant: -10))

        constraints.append(self.isDoneSwitch.centerYAnchor.constraint(
    ...
    private func setupDeleteButton() {
        ...
        self.deleteButton.addTarget(self,
                                    action: #selector(userDidTouchDeleteButton),
                                    for: .touchUpInside)
    }
