...
class TaskDetailViewController: UIViewController {
    ...
    weak var delegate: TaskDetailViewControllerDetailDelegate?
    ...
    private func setupLayout() {
        ...
        constraints.append(
            self.titleLabel.leadingAnchor.constraint(
                greaterThanOrEqualTo: self.view.safeAreaLayoutGuide.leadingAnchor, constant: 10))

        constraints.append(
            self.titleLabel.trailingAnchor.constraint(
                lessThanOrEqualTo: self.view.safeAreaLayoutGuide.trailingAnchor, constant: -10))

        constraints.append(self.textView.topAnchor.constraint(
            equalTo: self.titleLabel.bottomAnchor, constant: 10))

        constraints.append(self.textView.leadingAnchor.constraint(
            equalTo: self.view.safeAreaLayoutGuide.leadingAnchor, constant: 10))

        constraints.append(self.textView.trailingAnchor.constraint(
            equalTo: self.view.safeAreaLayoutGuide.trailingAnchor, constant: -10))

        constraints.append(self.doneLabel.leadingAnchor.constraint(
            equalTo: self.view.safeAreaLayoutGuide.leadingAnchor, constant: 10))

        constraints.append(self.doneLabel.bottomAnchor.constraint(
            equalTo: self.view.safeAreaLayoutGuide.bottomAnchor, constant: -10))

        constraints.append(
            self.doneLabel.centerYAnchor.constraint(
                equalTo: self.isDoneSwitch.centerYAnchor))

        constraints.append(
            self.isDoneSwitch.topAnchor.constraint(
                equalTo: self.textView.bottomAnchor, constant: 10))

        constraints.append(
            self.isDoneSwitch.leadingAnchor.constraint(
                equalTo: self.doneLabel.trailingAnchor, constant: 10))
        ...
        constraints.append(
            self.deleteButton.bottomAnchor.constraint(
                lessThanOrEqualTo: self.view.safeAreaLayoutGuide.bottomAnchor, constant: -10))
